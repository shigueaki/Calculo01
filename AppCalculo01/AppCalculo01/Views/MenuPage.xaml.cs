    ...
    public partial class MenuPage : ContentPage
    {
        ...
        public MenuPage()
        {
            ...
            menuItems = new List<HomeMenuItem>
            {
                ...
                new HomeMenuItem {Id = MenuItemType.DefinicaoDeFuncoes, Title="Definição de Funções", Icon="fas-home" },
                new HomeMenuItem {Id = MenuItemType.ContraExemplos, Title="Contra-Exemplos", Icon="fas-home" },
                new HomeMenuItem {Id = MenuItemType.Graficos, Title="Gráficos", Icon="fas-home" },
                new HomeMenuItem {Id = MenuItemType.Operacoes, Title="Operações", Icon="fas-home" },
